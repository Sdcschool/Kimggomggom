          ...
          $(document.body).ready(function () {
             ...
             // 그리드 설정 및 칼럼 생성..st
              var firstGrid = new ax5.ui.grid({
                 ...
                 columns: [
                    { key: "col01", label: "분류코드", width: 150, align: "center", editor: {type:"text"}, edableFilter: true},
                    { key: "col02", label: "분류명", width: 190, align: "center", editor: {type:"text"}},
                    { key: "col03", label: "코드", width: 100, align: "center", editor: {type:"text"}},
                    { key: "col04", label: "코드값", width: 100, align: "center", editor: {type:"text"}},
                    { key: "col05", label: "사용여부", width: 100, align: "center", editor: {type:"checkbox"}},
                    { key: "col06", label: "비고", width: 200, align: "left", editor: {type:"text"}}
                 ]
              });
              // 그리드 설정 및 칼럼 생성..end
              ...
              for(var startCount=0, lastCount=35; startCount<lastCount; startCount++){
                 list.push({
                    col01 : "B12345-401" + startCount,
                    col02 : "판매",
                    col03 : "AE015ST-" + startCount,
                    col04 : "한국",
                    col06 : "판매제품-" + startCount
                 });
              }
